...
function DataConverter(nodeId) {
  ...
  this.outputDataTypes        = [
                                ...
                                {"text":"XML - dmsconfig.xml",    "id":"xml",              "notes":""},
  ...
  this.commentLine            = "//";
  this.commentLineEnd         = "";
  this.tableName              = "DMSConfigBuilder"
...
DataConverter.prototype.insertSampleData = function() {
  this.inputTextArea.val("DataMap\tXpath\tPS 360 CustomField\nPatient Name\t/PatientData/Patient/PatientName\tLCS_PatientName\nPatient ID\t/PatientData/Patient/PatientID\tLCS_PatientID\nStudy Instance UID\t/PatientData/Study/StudyInstanceUID\tLCS_StudyInstanceUID");
}
